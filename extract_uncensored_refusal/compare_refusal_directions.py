...
def main():
    ...
    base_model_dir = os.path.join(script_dir, "../pipeline/runs/yi-6b-chat/direction.pt")
    uncensored_model_dir = os.path.join(script_dir, "refusal_direction/direction.pt")
